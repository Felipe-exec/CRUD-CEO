        ...
        <div id="top" class="row">
            ...
            <div class="col-md-6">
                <div class="input-group h2">
                    <input name="data[search]" class="form-control" id="search" type="text" placeholder="Pesquisar CEOs">
            ...
            <div class="col-md-3">
                <a href="/CRUD-CEO/ceo/form" class="btn btn-danger pull-right h2"><span class="glyphicon glyphicon-plus" /></span>&nbspAdicionar CEO</a>
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td class="actions">
                                    <a class="btn btn-danger btn-xs modal-remove"
                                       ceo-id="${ceo.getId()}" 
                                       ceo-name="${ceo.getCpf()}" data-toggle="modal" 
