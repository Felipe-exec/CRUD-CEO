...
<body>
    ...
    <div id="container" class="container-fluid">
        ...
        <div id="top" class="row">
            ...
            <div class="col-md-3">
                <a href="/CRUD-CEO/post/form" class="btn btn-danger pull-right h2"><span class="glyphicon glyphicon-plus" /></span>&nbspAdicionar Post</a>
            </div>
        </div>
                    ...
                    <tbody>
                        <c:forEach var="post" items="${posts}">
                            <tr>
                                ...
                                <td class="actions">
                                    <a class="btn btn-info btn-xs" href="${pageContext.request.contextPath}/post/update?postId=${post.getId()}">
                                        <span class="glyphicon glyphicon-edit"></span>
                                    </a>
                                </td>
                                <td class="actions">
                                    <a class="btn btn-danger btn-xs modal-remove" post-id="${post.getId()}" post-content="${post.getContent()}" data-toggle="modal" data-target="#delete-modal" href="#">
